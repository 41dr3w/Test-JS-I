...
function tienenMismaLongitud(str1, str2) {
  ...
  // Tu código:
  var result
  if(str2.length==str1.length)result=true
  else result=false
  return(result)
}
...
function esPositivo(numero) {
  ...
  if(numero>0) str="Es positivo"
  else if(numero<0) str="Es negativo"
        else str=false
...
function deEuroAdolar(euro) {
  ...
  return(euro*1.2)      //tendria que ingresar variable dolar a la funcion.
}
...
function esVocal(letra) {
  ...
  //Escribe tu código aquí
  if(letra.length>1) str="Dato incorrecto"  
  else if(letra.length==1){
      switch(letra){
        case 'a': case 'e': case 'i': case 'o': case 'u': str="Es vocal";
        break;                                       
      }  
    }
  return (str)
